package cn.rl520.cloud.common.system.api;
...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        GeneratorUtils.generateFile(dataSource,"cloud-system/cloud-system-api",new String[]{"sys_user","sys_role","sys_tenant","sys_client"},"wwb","cn.rl520.cloud.common.system.api",null);
    }
}
